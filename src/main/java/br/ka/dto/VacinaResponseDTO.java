...
public record VacinaResponseDTO(
        Long id, String nome, Integer quantidadeDoses, Integer doseAtual, String nomeProfissionalRealizouVacina, String localRealizado, String loteVacina, LocalDate dataRealizada
) {
